...
public class ExpressionParser
{
    ...
    private Dictionary<string, double> m_Consts = new Dictionary<string, double>();
    ...
    public ExpressionParser()
    {
        ...
        m_Funcs.Add("noise", (p) => Mathf.PerlinNoise((float)p.FirstOrDefault() + rndSeed, (float)p.ElementAtOrDefault(1) + rndSeed));
        m_Funcs.Add("rnd", (p) =>
        {
            if (p.Length == 2)
    ...
    public void AddConst(string aName, double aMethod)
    {
    ...
    public Dictionary<string, double> GetConsts()
    {
        return m_Consts;
    }
